...
type FakeHealthChecks struct {
	Fake *FakeHealthV1alpha1
	ns   string
}

var healthchecksResource = schema.GroupVersionResource{Group: "health.mbell.dev", Version: "v1alpha1", Resource: "healthchecks"}

var healthchecksKind = schema.GroupVersionKind{Group: "health.mbell.dev", Version: "v1alpha1", Kind: "HealthCheck"}
