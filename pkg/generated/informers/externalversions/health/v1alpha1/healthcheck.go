...
import (
	...
	v1alpha1 "github.com/mbellgb/healthcheck-controller/pkg/generated/listers/health/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.HealthV1alpha1().HealthChecks(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HealthV1alpha1().HealthChecks(namespace).Watch(options)
			},
		},
		&healthv1alpha1.HealthCheck{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *healthCheckInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&healthv1alpha1.HealthCheck{}, f.defaultInformer)
}
