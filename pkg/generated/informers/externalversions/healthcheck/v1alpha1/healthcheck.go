...
import (
	...
	healthcheckv1alpha1 "github.com/mbellgb/healthcheck-controller/pkg/apis/healthcheck/v1alpha1"
	versioned "github.com/mbellgb/healthcheck-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/mbellgb/healthcheck-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/mbellgb/healthcheck-controller/pkg/generated/listers/healthcheck/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.HealthcheckV1alpha1().HealthChecks(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HealthcheckV1alpha1().HealthChecks(namespace).Watch(options)
			},
		},
		&healthcheckv1alpha1.HealthCheck{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *healthCheckInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&healthcheckv1alpha1.HealthCheck{}, f.defaultInformer)
}
